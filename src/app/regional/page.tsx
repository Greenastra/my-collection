    ...
    >
      <header className="w-full max-w-[1200px] mx-auto pt-4 relative z-10">
        ...
        <nav className="bg-[#1a0505] text-white py-2 px-4 flex flex-wrap gap-6 text-sm font-bold border-b border-[#333] shadow-md justify-center md:justify-start">
          ...
          <Link href="/regional" className="text-[#ffcc00] underline transition">Региональный комсомол</Link>
      ...
      <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row mt-6 gap-4 px-2">
          ...
          <div className="bg-[#2a0a0a] rounded p-4 shadow-xl border border-[#3d1414]">
            ...
            <div className="text-gray-300 space-y-2 text-sm">
              <details open className="cursor-pointer group">
                <summary className="font-bold text-[#ffcc00] list-none border-l-2 border-[#cc0000] pl-2 bg-[#3d0a0a] p-1">
                  Региональный комсомол
                </summary>
                <ul className="pl-4 mt-2 space-y-1 text-[#aaa] border-l border-[#444] ml-1">
                  <li className="hover:text-white cursor-pointer pl-2 hover:bg-[#4a0e0e]">└ Города</li>
                  <li className="hover:text-white cursor-pointer pl-2 hover:bg-[#4a0e0e]">└ Области</li>
                </ul>
              </details>
              
              <Link href="/sso" className="block font-bold text-white hover:text-[#ffcc00] border-t border-[#3d1414] pt-2 mt-2">
                ССО
              </Link>
        ...
        <section className="flex-1 bg-white rounded p-8 shadow-2xl relative">
          ...
          <p className="text-gray-600">Здесь будут значки Республик, Краев и Областей...</p>
        </section>
      </div>
    </main>
  )
