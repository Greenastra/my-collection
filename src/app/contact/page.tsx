  ...
  return (
    <main className="min-h-screen pb-10" style={{ backgroundColor: '#2e0a12', backgroundImage: 'repeating-linear-gradient(90deg, #2e0a12, #2e0a12 15px, #21050a 15px, #21050a 30px)' }}>
      <header className="w-full max-w-[1200px] mx-auto pt-4 relative z-10">
        ...
        {/* МЕНЮ: text-xl font-bold - Единый стандарт */}
      ...
      <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row mt-6 gap-4 px-2">
        ...
        <section className="flex-1 bg-white rounded p-8 shadow-2xl relative">
          <h1 className="text-3xl font-serif font-bold text-[#800000] border-b-2 border-[#eee] mb-6 pb-2">Связь с автором</h1>
          <div className="text-gray-800 leading-relaxed font-serif text-lg space-y-4">
            <p>Если у вас есть вопросы по коллекции, предложения по обмену или вы заметили неточность в описании значков, буду рад получить от вас сообщение.</p>
            <div className="bg-gray-50 border-l-4 border-[#cc0000] p-4 my-6">
              <p className="font-bold text-[#800000]">Электронная почта:</p>
              <a href="mailto:email@example.com" className="text-blue-700 hover:underline">email@example.com</a>
            </div>
            <h2 className="text-xl font-bold text-[#800000] mt-8 mb-4 border-b border-gray-200 pb-1">Написать сообщение</h2>
            <form className="space-y-4 max-w-lg">
              ...
              <button type="button" className="bg-[#800000] text-white font-bold py-2 px-6 rounded hover:bg-[#600000] transition shadow-md">Отправить</button>
            </form>
          </div>
        </section>
      </div>
